...
$Present\ value = PV = 2000/12$; $Future \space Value = FV = (t_4)2000/3; 2000/1$; $with\space \delta = \frac{PV}{2}$$
we have :
$$\delta_4 = (\frac{2000/12}{2000/3})^3 \approx 0.01565 \\ \delta_6 = (\frac{2000/12}{2000/2})^2 \approx 0.027 \\ \delta_{12} = (\frac{2000/12}{2000})^1 \approx 0.0833  $$
