...
summary of discounted utilities:
...
- T = 0, she prefers to watch the 4th movie, thus she does not go to the first movie. $2.5_{u_2} < 3_{u_1} < 4_{u_3} < 6.5_{u_4}$
- T = 1, she still prefers the 4th movie, thus she does not go the the second film. $4_{u_3} < 5_{u_2} < 6.5_{u_4}$
- T = 2, she perceived a higher utility in watching the 3rd movie now rather than wait for the last week $8_{u_3} > 6.5_{u_4}$
