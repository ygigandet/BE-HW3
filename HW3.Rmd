...
As she is naive, she wrongly assumes that $\hat\beta = \beta = 1$. Hence:
...
$$
u(w_B) = \beta w_B - e \\
u(w_B) = 0.9(10'000 *(1+\frac{0.03}{365}*10'950)) - 0 \\
u(w_B) = 0.9(10'000 * 1.9) - 0 \\
u(w_B) = 17'100
$$

Utility of account C is given by:
$$
u(w_C) = \beta w_C - e \\
u(w_C) = 0.9(10'000 *(1+\frac{0.05}{365}*10'950)) - 60 \\
u(w_C) = 0.9(10'000 * 2.5) - 60 \\
u(w_C) = 22'440
$$
