...
**I think there are two points to be addressed: the first is why the choose the sum lump payment and not the small amounts each month. The second, why they rush to a tax preparer to get it rapidly**
...
The second inconsistency is given by the fact that most families pay a tax preparer in an effort to get the refund ine one day or two instead of filling their taxes themselves an get the refund in a few weeks.
...
**PAS COMPRIS CE QUE TU VEUX EXPLIQUER LA**
